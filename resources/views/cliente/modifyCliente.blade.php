                ...
                <div class="row">
                    <div class="col-lg">
                        <input type="text" name="cnombre" class="form-control"
                               value="{{$cliente->cnombre}}" placeholder="Nombre">
                    </div>

                    <div class="col-lg">
                        <input type="text" name="capellido" class="form-control"
                               value="{{$cliente->capellido}}" placeholder="Apellido">
                    </div>
                </div>
                <br>
                <div class="row">
                    <div class="col-lg">
                        <input type="text" name="ctelefono" class="form-control"
                               value="{{$cliente->ctelefono}}" placeholder="Telefono">
                    </div>

                    <div class="col-lg">
                        <input type="text" name="cemail" class="form-control"
                               value="{{$cliente->cemail}}" placeholder="Email">
                    </div>
                </div>
                <br>
                <div class="row">
                    <div class="col-lg">
                        <input type="text" name="cdireccion" class="form-control"
                               value="{{$cliente->cdireccion}}" placeholder="Direccion">
                    </div>

                    <div class="col-lg">
                        <input type="text" name="num_servicio" class="form-control"
                               value="{{$cliente->num_servicio}}" placeholder="Numero de Servicio">
                    </div>
                </div>
                <br>
                <div class="row">
                    <div class="row form-group">
                        <button id="Guardado" type="submit" class="btn btn-outline-info col-md-4 offset-2 mr-3" onclick="save()">
                            <i class="fas fa-save"></i> Editar Cliente
                        </button>
